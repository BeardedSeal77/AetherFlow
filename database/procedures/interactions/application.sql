-- =============================================================================
-- INTERACTIONS: CUSTOMER APPLICATION PROCESSING
-- =============================================================================
-- Purpose: Process new customer applications (individual or company)
-- Uses generic customer (ID 999) and creates application interaction
-- Creates task for hire_control team to process application
-- =============================================================================

SET search_path TO core, interactions, tasks, security, system, public;

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS interactions.create_application;

-- Create the application processing procedure
...
-- GRANT EXECUTE ON FUNCTION interactions.create_application TO hire_control;
-- GRANT EXECUTE ON FUNCTION interactions.create_application TO manager;
-- GRANT EXECUTE ON FUNCTION interactions.create_application TO owner;
...
SELECT * FROM interactions.create_application(
    'individual',                           -- p_application_type
    'John',                                 -- p_applicant_first_name
    'Smith',                                -- p_applicant_last_name
    'john.smith@email.com',                 -- p_applicant_email
    'email',                                -- p_contact_method
    'ID document, proof of income',         -- p_documents_required
    NULL,                                   -- p_documents_received
    'Initial application via website',      -- p_verification_notes
    'Customer called to inquire about equipment rental', -- p_initial_notes
    1001                                    -- p_employee_id
);

-- Example 2: Company application
SELECT * FROM interactions.create_application(
    'company',                              -- p_application_type
    'Sarah',                                -- p_applicant_first_name
    'Williams',                             -- p_applicant_last_name
    'sarah@techsolutions.co.za',           -- p_applicant_email
    'phone',                                -- p_contact_method
    'Company registration, VAT certificate, director ID', -- p_documents_required
    'Registration certificate received',     -- p_documents_received
    'Large construction company, good credit history', -- p_verification_notes
    'Referred by existing customer ABC Construction', -- p_initial_notes
    1002                                    -- p_employee_id
);

-- Example 3: Update application status
SELECT * FROM interactions.update_application_status(
    123,                                    -- p_interaction_id
    'documents_requested',                  -- p_verification_status
    'Requested ID document and proof of income via email', -- p_verification_notes
    NULL,                                   -- p_approved_by
    1001                                    -- p_employee_id
);

-- Example 4: Approve application
SELECT * FROM interactions.update_application_status(
    123,                                    -- p_interaction_id
    'approved',                             -- p_verification_status
    'All documents verified. Customer approved for rental account.', -- p_verification_notes
    1001,                                   -- p_approved_by
    1001                                    -- p_employee_id
);

-- Example 5: Using session token
SELECT * FROM interactions.create_application(
    'individual',
    'Mary',
    'Johnson',
    ...
    NULL,
    NULL,
    'Online application via website form',
    NULL,
    NULL,                                   -- p_employee_id
